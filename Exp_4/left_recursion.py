...
if __name__ == "__main__":
    ...
    with open("no_left_recursion_grammar.txt", "w") as f:
        f.write("Grammar after removing Left Recursion:\n\n")
        for nt in new_grammar:
            f.write(f"{nt} -> {' | '.join(new_grammar[nt])}\n")

    print("Left recursion removed! Output saved to 'no_left_recursion_grammar.txt'.")